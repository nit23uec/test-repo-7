...
## Environments
- Preview: https://main--test-repo-7--nit23uec.hlx.page/
- Live: https://main--test-repo-7--nit23uec.hlx.live/
...
1. Open the `test-repo-7` directory in your favorite IDE and start coding :)
